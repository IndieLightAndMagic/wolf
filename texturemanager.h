...
public:
	static void initializeTextures(GLuint* ptbo, const std::string filename_texture);


};


void TextureManagerQT::initializeTextures(GLuint* ptbo, const std::string filename_texture){
